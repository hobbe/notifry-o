...
public class C2DMReceiver extends C2DMBaseReceiver
{
	...
	protected void onMessage( Context context, Intent intent )
	{
		...
		if( type.equals("message") )
		{
			...
			try
			{
				...
				// Send a notification to the notification service, which will
				// then
		...
		{
			// Server says we've been deregistered. We should now clear our
			// registration.
	...
	private static final String PROJECT_NUMBER = "406214645437";
}
