...
public class SourceList extends ListActivity implements View.OnClickListener, CompoundButton.OnCheckedChangeListener
{
	...
	{
		// We need to send this request to the backend, and then it will set up
		// everything we need.
	...
	/**
	 * Sync the list with the server. This half starts the request to the
	 * backend.
	 */
	...
	private class SourceArrayAdapter extends ArrayAdapter<NotifrySource>
	{
		...
		private final ArrayList<NotifrySource> sources;
	}
