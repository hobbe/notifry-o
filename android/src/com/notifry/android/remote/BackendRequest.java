...
public class BackendRequest
{
	...
	/**
	 * Add metadata to this request - this is for the final handler to be able
	 * to get the context and deal with the request.
	 * 
	 * @param name
	 * @param object
	 */
	 ...
	 * @param statusMessage
	 *            If provided, show a progress dialog with this message. If
	 *            NULL, no progress dialog is shown.
	 * @param accountName
	 *            The account name to perform the request under.
	 */
		...
		Thread thread = new Thread()
		{
			...
			public void run()
			{
				...
				try
				{
					...
					// Was it successful?
					/*
					 * if( result.isError() ) { Log.e(TAG, "Error: " +
					 * result.getError()); } else { Log.e(TAG,
					...
					// Post it to ourselves - it will then post it back to the
					// real thread.
